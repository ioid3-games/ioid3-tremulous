...
Resolve an internet address. Name may include a port number, after a ':'.
=======================================================================================================================================
*/
...
Return qtrue if a server is active. Test if the server has timed out and remove it if it's the case.
=======================================================================================================================================
*/
...
server_t *Sv_GetByAddr(const struct sockaddr_in * address, qboolean add_it) {
	...
	while (sv != NULL) {
		...
		if (sv->address.sin_addr.s_addr == address->sin_addr.s_addr && sv->address.sin_port == address->sin_port) {
			// put it on top of the list(it's useful because heartbeats are almost always followed by infoResponses)
			*prev = sv->next;
...
Add an unresolved address mapping to the list. Mapping must be of the form "addr1:port1 = addr2:port2", ":portX" are optional.
=======================================================================================================================================
*/
