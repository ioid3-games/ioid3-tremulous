...
static void CG_PlayerSplash(centity_t *cent, class_t class) {
	...
	CG_ImpactMark(cgs.media.wakeMarkShader, trace.endpos, trace.plane.normal, cent->pe.legs.yawAngle, 1.0f, 1.0f, 1.0f, 1.0f, qfalse, 32.0f * BG_ClassConfig(class)->shadowScale, qtrue);
}
