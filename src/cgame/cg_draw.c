...
=======================================================================================================================================
*/
static void CG_AlignText(rectDef_t *rect, const char *text, float scale, float w, float h, int align, int valign, float *x, float *y) {
	float tx, ty;
...
=======================================================================================================================================
*/
static void CG_DrawProgressBar(rectDef_t *rect, vec4_t color, float scale, int align, int textalign, int textStyle, float borderSize, float progress) {
	float rimWidth;
...
static void CG_DrawPlayerCreditsValue(rectDef_t *rect, vec4_t color, qboolean padding) {
	...
	if (value > -1) {
		if (cg.predictedPlayerState.stats[STAT_TEAM] == TEAM_ALIENS) {
			if (!BG_AlienCanEvolve(cg.predictedPlayerState.stats[STAT_CLASS], value, cgs.alienStage) && cg.time - cg.lastEvolveAttempt <= NO_CREDITS_TIME && ((cg.time - cg.lastEvolveAttempt) / 300) & 1) {
				color[3] = 0.0f;
			}
...
=======================================================================================================================================
*/
static void CG_DrawPlayerStamina(int ownerDraw, rectDef_t *rect, vec4_t backColor, vec4_t foreColor, qhandle_t shader) {
...
=======================================================================================================================================
*/
static void CG_DrawPlayerStaminaBolt(rectDef_t *rect, vec4_t backColor, vec4_t foreColor, qhandle_t shader) {
...
=======================================================================================================================================
*/
static void CG_DrawPlayerClipsRing(rectDef_t *rect, vec4_t backColor, vec4_t foreColor, qhandle_t shader) {
	playerState_t *ps = &cg.snap->ps;
	centity_t *cent;
...
=======================================================================================================================================
*/
static void CG_DrawPlayerBuildTimerRing(rectDef_t *rect, vec4_t backColor, vec4_t foreColor, qhandle_t shader) {
	playerState_t *ps = &cg.snap->ps;
	float buildTime = ps->stats[STAT_MISC];
	float progress;
	vec4_t color;
...
=======================================================================================================================================
*/
static void CG_DrawPlayerBoosted(rectDef_t *rect, vec4_t backColor, vec4_t foreColor, qhandle_t shader) {
...
=======================================================================================================================================
*/
static void CG_DrawPlayerBoosterBolt(rectDef_t *rect, vec4_t backColor, vec4_t foreColor, qhandle_t shader) {
	vec4_t color;
...
static void CG_DrawPlayerPoisonBarbs(rectDef_t *rect, vec4_t color, qhandle_t shader) {
	...
	// adjust these first to ensure the aspect ratio of the barb image is preserved
...
static void CG_DrawUsableBuildable(rectDef_t *rect, qhandle_t shader, vec4_t color) {
	...
	if (es->eType == ET_BUILDABLE && BG_Buildable(es->modelindex)->usable && cg.predictedPlayerState.stats[STAT_TEAM] == BG_Buildable(es->modelindex)->team) {
...
/*
=======================================================================================================================================
CG_DrawPlayerChargeBarBG
=======================================================================================================================================
*/
static void CG_DrawPlayerChargeBarBG(rectDef_t *rect, vec4_t ref_color, qhandle_t shader) {
	vec4_t color;
...
/*
=======================================================================================================================================
CG_DrawPlayerChargeBar
=======================================================================================================================================
*/
static void CG_DrawPlayerChargeBar(rectDef_t *rect, vec4_t ref_color, qhandle_t shader) {
	vec4_t color;
...
=======================================================================================================================================
*/
static void CG_DrawProgressLabel(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign, const char *s, float fraction) {
...
=======================================================================================================================================
*/
static void CG_DrawMediaProgress(rectDef_t *rect, vec4_t color, float scale, int align, int textalign, int textStyle, float borderSize) {
...
=======================================================================================================================================
*/
static void CG_DrawMediaProgressLabel(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign) {
	CG_DrawProgressLabel(rect, text_x, text_y, color, scale, textalign, textvalign, "Map and Textures", cg.mediaFraction);
}

/*
=======================================================================================================================================
CG_DrawBuildablesProgress
=======================================================================================================================================
*/
static void CG_DrawBuildablesProgress(rectDef_t *rect, vec4_t color, float scale, int align, int textalign, int textStyle, float borderSize) {
...
=======================================================================================================================================
*/
static void CG_DrawBuildablesProgressLabel(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign) {
	CG_DrawProgressLabel(rect, text_x, text_y, color, scale, textalign, textvalign, "Buildable Models", cg.buildablesFraction);
}
...
=======================================================================================================================================
*/
static void CG_DrawCharModelProgress(rectDef_t *rect, vec4_t color, float scale, int align, int textalign, int textStyle, float borderSize) {
...
=======================================================================================================================================
*/
static void CG_DrawCharModelProgressLabel(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign) {
	CG_DrawProgressLabel(rect, text_x, text_y, color, scale, textalign, textvalign, "Character Models", cg.charModelFraction);
}

/*
=======================================================================================================================================
CG_DrawOverallProgress
=======================================================================================================================================
*/
static void CG_DrawOverallProgress(rectDef_t *rect, vec4_t color, float scale, int align, int textalign, int textStyle, float borderSize) {
	float total;
...
=======================================================================================================================================
*/
static void CG_DrawLevelName(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign, int textStyle) {
	const char *s;
...
=======================================================================================================================================
*/
static void CG_DrawMOTD(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign, int textStyle) {
	const char *s;
...
=======================================================================================================================================
*/
static void CG_DrawHostname(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign, int textStyle) {
	char buffer[1024];
	const char *info;
...
static void CG_DrawKiller(rectDef_t *rect, float scale, vec4_t color, qhandle_t shader, int textStyle) {
	...
	if (cg.killerName[0]) {
		...
		UI_Text_Paint(x - UI_Text_Width(CG_GetKillerText(), scale) / 2, rect->y + rect->h, scale, color, CG_GetKillerText(), 0, 0, textStyle);
	}
}
...
=======================================================================================================================================
*/
static void CG_DrawFollow(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign, int textStyle) {
	float tx, ty;
...
=======================================================================================================================================
*/
static void CG_DrawTeamLabel(rectDef_t *rect, team_t team, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign, int textStyle) {
	char *t;
...
=======================================================================================================================================
*/
static void CG_DrawStageReport(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign, int textStyle) {
...
=======================================================================================================================================
*/
static void CG_DrawTimer(rectDef_t *rect, float text_x, float text_y, float scale, vec4_t color, int textalign, int textvalign, int textStyle) {
	const char *s;
	float tx, ty;
	int i, strLength;
	float w, h, totalWidth;
...
static int QDECL SortWeaponClass(const void *a, const void *b) {
	...
	if (ca->team == TEAM_ALIENS) {
		if (ca->curWeaponClass == PCL_ALIEN_BUILDER0_UPG || cb->curWeaponClass == PCL_ALIEN_BUILDER0_UPG || ca->curWeaponClass == PCL_ALIEN_BUILDER0 || cb->curWeaponClass == PCL_ALIEN_BUILDER0) {
			out = -out;
		}
	}
		...
		for (i = 0; i < MAX_CLIENTS; i++) {
			...
			if (ci->infoValid && pci != ci && ci->team == pci->team) {
				if (mode == TEAMOVERLAY_ALL) {
					...
					if (ci->curWeaponClass == PCL_ALIEN_BUILDER0 || ci->curWeaponClass == PCL_ALIEN_BUILDER0_UPG || ci->curWeaponClass == PCL_ALIEN_LEVEL1 || ci->curWeaponClass == PCL_ALIEN_LEVEL1_UPG || ci->curWeaponClass == WP_HBUILD) {
						displayClients[maxDisplayCount++] = i;
					}
				}
			}
	...
	for (i = 0; i < MAX_CLIENTS && displayCount < maxDisplayCount; i++) {
		...
		if (ci->health <= 0 || !ci->curWeaponClass) {
			...
			if (cg.predictedPlayerState.stats[STAT_TEAM] == TEAM_HUMANS) {
				...
				if (curWeapon == WP_ABUILD2 || curWeapon == WP_ALEVEL1_UPG || curWeapon == WP_ALEVEL2_UPG || curWeapon == WP_ALEVEL3_UPG) {
					CG_DrawPic(x + iconSize + leftMargin, y, iconSize, iconSize, cgs.media.upgradeClassIconShader);
				}
			}

			s = va(" [^%c%3d^7] ^7%s", CG_GetColorCharForHealth(displayClients[i]), ci->health, CG_ConfigString(CS_LOCATIONS + ci->location));
		}

		trap_R_SetColor(NULL);
		nameMaxX = nameMaxXCp = x + 2.0f * iconSize + leftMargin + midSep + nameWidth;
		UI_Text_Paint_Limit(&nameMaxXCp, x + 2.0f * iconSize + leftMargin + midSep, y + iconSize - iconTopMargin, fontScale, tcolor, name, 0, 0);
...
=======================================================================================================================================
*/
static void CG_DrawClock(rectDef_t *rect, float text_x, float text_y, float scale, vec4_t color, int textalign, int textvalign, int textStyle) {
	const char *s;
	float tx, ty;
	int i, strLength;
	float w, h, totalWidth;
...
=======================================================================================================================================
*/
static void CG_DrawSnapshot(rectDef_t *rect, float text_x, float text_y, float scale, vec4_t color, int textalign, int textvalign, int textStyle) {
	const char *s;
	float tx, ty;
...
=======================================================================================================================================
*/
static void CG_DrawKillMsg(rectDef_t *rect, float text_x, float text_y, float scale, vec4_t color, int textalign, int textvalign, int textStyle) {
	int i;
	vec4_t hcolor;
	int chatHeight;
	...
	if (cgs.killMsgLastPos != cgs.killMsgPos) {
		if (cg.time - cgs.killMsgMsgTimes[cgs.killMsgLastPos % chatHeight] > cg_killMsgTime.integer) {
			...
			for (i = cgs.killMsgPos - 1; i >= cgs.killMsgLastPos; i--) {
				...
				UI_Text_Paint(rect->x + TINYCHAR_WIDTH, rect->y - (cgs.killMsgPos - i) * 20, scale, color, cgs.killMsgKillers[j], 0, 0, textStyle);
				x += w + 3;

				if (cg_weapons[cgs.killMsgWeapons[j]].weaponIcon != WP_NONE) {
					CG_DrawPic(rect->x + TINYCHAR_WIDTH + x, rect->y - (cgs.killMsgPos - i) * 20 - 15, 16, 16, cg_weapons[cgs.killMsgWeapons[j]].weaponIcon);
					x += 16 + 2;

					w = UI_Text_Width(cgs.killMsgVictims[j], scale);
					UI_Text_Paint(rect->x + TINYCHAR_WIDTH + x, rect->y - (cgs.killMsgPos - i) * 20, scale, color, cgs.killMsgVictims[j], 0, 0, textStyle);
				}
			}
		}
	}
...
=======================================================================================================================================
*/
static void CG_DrawSpeedGraph(rectDef_t *rect, vec4_t foreColor, vec4_t backColor) {
	int i;
	float val, max, top;
	...
	for (i = 1; i < SPEEDOMETER_NUM_SAMPLES; i++) {
		...
		CG_DrawPic(rect->x + (i / (float)SPEEDOMETER_NUM_SAMPLES) * rect->w, top, rect->w / (float)SPEEDOMETER_NUM_SAMPLES, val * rect->h / max, cgs.media.whiteShader);
	}
...
=======================================================================================================================================
*/
static void CG_DrawSpeedText(rectDef_t *rect, float text_x, float text_y, float scale, vec4_t foreColor) {
	char speedstr[16];
	float val;
	vec4_t color;
	...
	UI_Text_Paint(rect->x + (rect->w - UI_Text_Width(speedstr, scale)) / 2.0f, rect->y + (rect->h + UI_Text_Height(speedstr, scale)) / 2.0f, scale, color, speedstr, 0, 0, ITEM_TEXTSTYLE_NORMAL);
}
...
=======================================================================================================================================
*/
static void CG_DrawSpeed(rectDef_t *rect, float text_x, float text_y, float scale, vec4_t foreColor, vec4_t backColor) {
...
=======================================================================================================================================
*/
static void CG_DrawConsole(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign, int textStyle) {
...
=======================================================================================================================================
*/
static void CG_DrawTutorial(rectDef_t *rect, float text_x, float text_y, vec4_t color, float scale, int textalign, int textvalign, int textStyle) {
...
void CG_DrawWeaponIcon(rectDef_t *rect, vec4_t color) {
	...
	if (!cg_weapons[weapon].registered) {
		Com_Printf(S_COLOR_YELLOW "WARNING: CG_DrawWeaponIcon : weapon %d(%s) is not registered\n", weapon, BG_Weapon(weapon)->name);
		return;
	}
	...
	if (cg.predictedPlayerState.stats[STAT_TEAM] == TEAM_ALIENS && !BG_AlienCanEvolve(cg.predictedPlayerState.stats[STAT_CLASS], ps->persistant[PERS_CREDIT], cgs.alienStage)) {
...
static void CG_DrawCrosshairNames(rectDef_t *rect, float scale, int textStyle) {
	...
	if (cg_teamOverlayUserinfo.integer && cg.snap->ps.stats[STAT_TEAM] != TEAM_NONE && cgs.teaminfoReceievedTime && cgs.clientinfo[cg.crosshairClientNum].health > 0) {
...
=======================================================================================================================================
*/
void CG_OwnerDraw(float x, float y, float w, float h, float text_x, float text_y, int ownerDraw, int ownerDrawFlags, int align, int textalign, int textvalign, float borderSize, float scale, vec4_t foreColor, vec4_t backColor, qhandle_t shader, int textStyle) {
	rectDef_t rect;
...
static void CG_Draw2D(void) {
	...
	// fading to black if stamina runs out (only 2D that can't be disabled)
	CG_DrawLighting();
	...
	if (cg.snap->ps.stats[STAT_TEAM] == TEAM_NONE || (cg.snap->ps.persistant[PERS_SPECSTATE] == SPECTATOR_NOT && cg.snap->ps.stats[STAT_HEALTH] > 0)) {
