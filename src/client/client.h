...
typedef struct {
	int timeoutcount; // it requres several frames in a timeout condition  to disconnect, preventing debugging breaks from causing immediate disconnects on continue
