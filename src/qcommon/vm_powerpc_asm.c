...
#define BI BA
#define BI_MASK(0x1f << 16) {0x1f, 16, NULL, PPC_OPERAND_CR}, 
...
#define OBF BF + 1
  ...
  /* The BO field in a B form instruction. Certain values are
     illegal. */
#define BO OBF + 1
#define BO_MASK(0x1f << 21) {0x1f, 21, insert_bo, 0}, 
...
#define FRA DS + 1
#define FRA_MASK(0x1f << 16) {0x1f, 16, NULL, PPC_OPERAND_FPR}, 

  /* The FRB field in an X or A form instruction. */
#define FRB FRA + 1
#define FRB_MASK(0x1f << 11) {0x1f, 11, NULL, PPC_OPERAND_FPR}, 

  /* The FRC field in an A form instruction. */
#define FRC FRB + 1
#define FRC_MASK(0x1f << 6) {0x1f, 6, NULL, PPC_OPERAND_FPR}, 
...
#define ME LI + 1
#define ME_MASK(0x1f << 1) {0x1f, 1, NULL, 0}, 
...
#define RA MBE + 1
#define RA_MASK(0x1f << 16) {0x1f, 16, NULL, PPC_OPERAND_GPR}, 
...
#define RB RAS + 1
#define RB_MASK(0x1f << 11) {0x1f, 11, NULL, PPC_OPERAND_GPR}, 
...
#define RS RBS + 1
#define RT RS
#define RT_MASK(0x1f << 21) {0x1f, 21, NULL, PPC_OPERAND_GPR}, 
...
insert_bdm(unsigned long insn, long value, int dialect, const char **errmsg ATTRIBUTE_UNUSED) {
...
static unsigned long
insert_ras(unsigned long insn, long value, int dialect ATTRIBUTE_UNUSED, const char **errmsg) {
  if (value == 0)
...
static unsigned long
insert_rbs(unsigned long insn, long value ATTRIBUTE_UNUSED, int dialect ATTRIBUTE_UNUSED, const char **errmsg ATTRIBUTE_UNUSED) {
