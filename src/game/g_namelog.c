...
void G_namelog_connect(gclient_t *client) {
	...
	// if they're muted, copy in their last known name - this will stop people reconnecting to get around the name change protection.
